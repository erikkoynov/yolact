...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, net, predictions, targets, masks, num_crowds):
        ...
        if cfg.train_boxes:
            ...
            losses["B"] = (
                F.smooth_l1_loss(loc_p, loc_t, reduction="sum") * cfg.bbox_alpha
            )
    ...
    def focal_conf_sigmoid_loss(self, conf_data, conf_t):
        ...
        at[..., 0] = (
            0  # Set alpha for the background class to 0 because sigmoid focal loss doesn't use it
        )
    ...
    def lincomb_mask_loss(
        ...
        for idx in range(mask_data.size(0)):
            ...
            if cfg.mask_proto_normalize_emulate_roi_pooling:
                ...
                pre_loss = (
                    pre_loss.sum(dim=(0, 1)) / gt_box_width / gt_box_height * weight
                )
